...
namespace apps\dashboard\service;

use th\co\bpg\cde\core\CServiceBase;
use th\co\bpg\cde\data\CDataContext;
use th\co\bpg\cde\collection\CJView;
use th\co\bpg\cde\collection\CJViewType;
use apps\dashboard\interfaces\IDashboardService;

use apps\common\entity;
use apps\common\entity\Department;

class DashboardService extends CServiceBase implements IDashboardService  {
    ...
    public function index() {
        $view = new CJView("Dashboard", CJViewType::HTML_VIEW_ENGINE);
        return $view;
    }

...
namespace apps\login2\service;

use th\co\bpg\cde\core\CServiceBase;
use th\co\bpg\cde\data\CDataContext;
use th\co\bpg\cde\collection\CJView;
use th\co\bpg\cde\collection\CJViewType;
use apps\login2\interfaces\ILoginService;

use apps\common\entity;
use apps\common\entity\Department;

class LoginService extends CServiceBase implements ILoginService  {
    ...
    public function viewLogin() {
        $view = new CJView("login", CJViewType::HTML_VIEW_ENGINE);
        return $view;
    }

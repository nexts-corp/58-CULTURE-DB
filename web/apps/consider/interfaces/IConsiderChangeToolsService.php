...
/**
 * @name IConsiderChangeToolsService
 * @uri /considerchangetools
 * @description แจ้งเพิ่มจำนวนเครื่องมือ อุปกรณ์ หรือสิ่งอำนวยความสะดวก
 */
interface IConsiderChangeToolsService {
